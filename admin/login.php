    ...
    if (empty($username) || empty($password)) {
        ...
        if ($result['success']) {
            if ($result['user']['role'] === 'super_admin') {
                ...
                // Manager - redirect to slug-based URL
...
<head>
    ...
    <title>Admin Login - Restaurant Menu Platform</title>
...
<body>
    <div class="login-wrapper">
        ...
        <p class="subtitle">Make a new doc to bring your words, data, and teams together. For free</p>
        ...
        <form method="POST" action="">
            <div class="form-container">
                ...
                <div class="input-group">
                    ...
                    <div class="password-input-wrapper">
                        ...
                        <button type="button" class="password-toggle" aria-label="Toggle password visibility">
                            ...
                            <svg class="eye-closed" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" style="display: none;">
                ...
                <div class="forgot-password">
                    ...
                    <?php endif; ?>
                    <button type="button" style="<?php echo $error ? 'margin-left: auto;' : ''; ?>">Forgot password?</button>
                </div>
            </div>
