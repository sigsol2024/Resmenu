...
<h2 class="text-transparent bg-clip-text bg-gradient-to-r from-red-500 to-red-700 text-xl md:text-2xl font-black uppercase tracking-widest mb-8"><?php echo htmlspecialchars($section['name']); ?></h2>
</div>
</div>
